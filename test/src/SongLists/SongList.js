                ...
                <Col md={8}>
                    {songs.map((s, index) => (
                        <Row key={s.id} style={{ border: "1px solid black", marginTop: "10px" }}>
                            <Col>
                                <p onClick={() => handleSongClick(s.id)}>{index + 1}. {s.title} - {s.artist}</p>
                            </Col>
                            <Col><p><i className="bi bi-suit-heart"></i></p></Col>
                            <Col><p><i className="bi bi-play-circle"></i></p></Col>
                            <Col><p><i className="bi bi-share"></i></p></Col>
                        </Row>
                    ))}
                    {songplay && (
                        <>
